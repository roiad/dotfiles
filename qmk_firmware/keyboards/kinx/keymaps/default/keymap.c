...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE]=LAYOUT(
		...
		KC_CAPS  , KC_Q     , KC_W    , KC_E     , KC_R    , KC_T           , KC_Y        , KC_U        , KC_I	    , KC_O   , KC_P     , KC_SLASH,
		KC_TAB   , KC_A     , KC_S    , KC_D     , KC_F    , KC_G           , KC_H        , KC_J        , KC_K      , KC_L   , KC_COLON , KC_QUOTE  ,
		KC_LSFT  , KC_Z     , KC_X    , KC_C     , KC_V    , KC_B           , KC_N        , KC_M        , KC_COMMA  , KC_DOT , KC_SLASH , KC_RSFT   ,
		                      KC_DOWN , KC_UP    , KC_LEFT , KC_RIGHT       , KC_GRV      , KC_BSLS     , KC_LBRC   , KC_RBRC,
		KC_BSPC  , MO(_FN)  , KC_ESC  , KC_LCTL  , TG(_TAS), KC_LGUI        , KC_LGUI     , TG(_FN)     , KC_LCTL   , KC_RALT, KC_ENT   , KC_SPC
		),
	[_FN]=LAYOUT(
