...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE]=LAYOUT(
		...
		KC_ESCAPE , KC_A   , KC_S    , KC_D     , KC_F    , KC_G           , KC_H        , KC_J        , KC_K     , KC_L   , KC_COLON      , KC_QUOTE  ,
		KC_LSFT  , KC_Z   , KC_X    , KC_C     , KC_V    , KC_B           , KC_N        , KC_M        , KC_COMMA , KC_DOT , KC_SLASH  , KC_RSFT   ,
		                KC_GRV   , KC_BSLS , KC_LEFT , KC_RIGHT           , KC_DOWN   , KC_UP , KC_LBRC , KC_RBRC ,
		KC_BSPC  , KC_DEL , KC_LALT  , MO(_FN)  , KC_LCTL , KC_LGUI ,     KC_LGUI , KC_LCTL, MO(_FN), KC_RALT  , KC_ENT    , KC_SPC
		),
	[_FN] =LAYOUT(
